  ...
  return (
    <>
      ...
      <motion.main className="p-4 container mx-auto">
        ...
        <p>
          A <strong>Uniform Resource Locator (URL)</strong> is the address used
          to access a resource on the internet. Here's a breakdown of its parts:
        </p>
        <p>
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>
            <strong>Domain</strong> <Code>(www.example.com)</Code>: The address
            of the server hosting the resource. This resolves to an IP address
            behind the scenes.
          </li>
          <li>
          ...
          <li>
            <strong>Resource</strong> <Code>(/books/list.php)</Code>: The path
            to the specific file or resource on the server (a webpage, image,
            etc.).
          </li>
          <li>
            <strong>Query String</strong>
            <Code>(?category=fiction&sort=asc)</Code>: A series of key-value
            pairs sent to the server, often used to filter or customize the
            requested resource.
          </li>
          <li>
            <strong>Hash</strong> <Code>(#top)</Code>: An anchor or fragment
            identifier that takes you to a specific section of the page. takes
            you to a specific section of the page.
          </li>
        </ul>
        <h3 className="text-lg font-bold mt-2">
          1.3 The Request-Response Model
        </h3>
        <p>
          When you visit a website, your browser sends an HTTP request to the
          web server, which processes the request and sends back an HTTP
          response.
        </p>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              <li>
                <strong>GET:</strong> Retrieves data (e.g., a web page). It
                should not modify any data on the server.
              </li>
              <li>
                <strong>POST:</strong> Sends data to the server (e.g.,
                submitting a form) and often causes a change (e.g., adding a new
                record). often causes a change (e.g., adding a new record).
              </li>
              <li>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            ...
            successful (e.g., 200 OK) or encountered issues (e.g., 404 Not
            Found).
          </li>
          <li>
          ...
          <li>
            <strong>Body:</strong> The actual data returned, such as the HTML
            for a web page.
          </li>
        </ul>
        <h3 className="text-lg font-bold mt-2">
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              ...
              <li>
                <Code>Listen:</Code> The port Apache listens on. By default,
                this is 80.
              </li>
              <li>
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              ...
              <li>
                <Code>display_errors:</Code> Whether errors should be shown to
                the user (important during development).
              </li>
            </ul>
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            <strong>PHP is an interpreted language.</strong> This means that
            code is executed line-by-line on the server. There’s no need to
            compile PHP code before running it.
          </li>
          <li>
            <strong>Compiled languages </strong>(e.g., C, C++, Rust, Zig, Go
            etc.) are converted into machine code by a compiler before
            execution, making them generally faster but requiring a compilation
            step.
            <ul className="list-disc list-inside mt-2 ml-6">
              <li>
        ...
        <p>
          By default, Apache serves content from C:/xampp/htdocs. However, we
          want to set up a virtual host so we can access our project as if it
          were a real website.
        </p>
        <ol className="list-decimal list-inside mt-2">
          ...
          <li>
            ...
            <p>
              Below any existing content, add this configuration for your
              project:
            </p>
            <SyntaxHighlighter>{code.step1.add_vhost}</SyntaxHighlighter>
            <p>
              This block tells Apache that requests for bookstore.local should
              be served from the bookstore folder.
            </p>
          </li>
          <li>
            Update hosts File:
        ...
        <ol className="list-decimal list-inside mt-2">
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              <li>
                Turn on error reporting: Find <Code>display_errors</Code> and
                set it to On.
              </li>
              <li>
                Increase memory limit: Find <Code>memory_limit</Code> and
                increase it to 256M.
              </li>
            </ul>
          </li>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            <strong>Dynamic Greeting:</strong> Based on the time of day, the
            site greets the user with "Good morning," "Good afternoon," or "Good
            evening."
          </li>
          <li>
        ...
        <ol className="list-decimal list-inside mt-2">
          <li>
            ...
            <p>
              Go to <Code>http://bookstore.local/index.php</Code>. You should
              see a greeting and a list of book categories.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Create a new variable <Code>$featuredBook</Code> and use it to
              display a "Book of the Day" on the homepage. Randomize the book
              selection.
            </p>
            <p>
              <strong>Hint:</strong> Use the <Code>array_rand()</Code> function
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>
            ...
            (we’ll use an online image service like placekitten.com).
          </li>
          <li>
        ...
        <p>
          By the end of this part, students will learn to create individual
          arrays for each book property, and then combine them into one
          multidimensional associative array. This will make the data easier to
          manage and extend later on.
        </p>
        <h2 className="text-xl font-bold mt-2">
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            ...
            <Code>title</Code>, <Code>description</Code>, <Code>cover</Code>,
            and <Code>price</Code>.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            ...
            can access its properties using keys like{" "}
            <Code>$book['title']</Code>,<Code>$book['cover']</Code>, etc.
          </li>
        </ul>
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              ...
              <li>
                ...
                instead of the regular price. If there is no discount, display
                the regular price as usual.
              </li>
              <li>
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            The code checks if the <Code>discount_price</Code> is set for a
            book. If it is, the original price is crossed out, and the
        ...
        <p>
          Let's refactor the current loop that outputs the book details using
          the <Code>foreach: endforeach</Code> syntax:
        </p>
        <ol className="list-decimal list-inside mt-2">
          <li>
            Update your index.php file to use the new syntax. Replace the
            existing foreach loop with this cleaner approach:
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            ...
            file is not found, it will throw a warning but continue executing
            the script.
          </li>
          <li>
        ...
        <p>
          ...
          file, a popular format for data exchange between services, and load
          the data dynamically using PHP’s JSON functions.
        </p>
        ...
        <p>
          ...
          over the web. It's easy for humans to read and write, and it’s also
          easy for machines to parse and generate. It's the default format used
          in APIs to exchange data between services and clients.
        </p>
        ...
        <ol className="list-decimal list-inside mt-2">
          <li>
            Modify index.php to load the data from the JSON file instead of
            using a PHP array.
        ...
        <ol className="list-decimal list-inside mt-2">
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              <li>
                Modify the json_decode() function to return the data as an
                object (instead of an associative array). Update your PHP code
                to access the book properties using the object notation
                ($book-&gt;title instead of $book['title']).
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 ml-6">
              <li>
                Add a validation step before decoding the JSON. If the JSON
                fails to load or is invalid, display an error message instead of
                breaking the page.
                <p>
                  Hint: Use json_last_error() to check if decoding was
                  successful.
                </p>
              </li>
            </ul>
